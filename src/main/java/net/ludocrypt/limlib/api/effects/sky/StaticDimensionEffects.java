 ...
 * <p>
 * This is a simplification of the base {@link ModDimensionEffects} class, where
 * each setting is a static, non-changing value
 */
public class StaticDimensionEffects extends ModDimensionEffects {
	...
	public Codec<? extends ModDimensionEffects> getCodec() {
		return CODEC;
	}
