...
public class MazeTypes {
	...
	public static MazeComponent depthFirst(int width, int height, Random random) {
	...
	public static MazeComponent solve(MazeComponent mazeToSolve, Random random, Vec2i end, Vec2i... roots) {
